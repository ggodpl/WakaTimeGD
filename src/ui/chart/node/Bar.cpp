...
void Bar::resizeY(float ratio, float maxHeight) {
    ...
    auto targetBg = CCTargetedAction::create(this->m_background, easing1);
    auto targetBorder = CCTargetedAction::create(this->m_border, easing2);

    auto spawn = CCSpawn::create(targetBg, targetBorder, nullptr);
